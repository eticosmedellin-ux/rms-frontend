...
export const activarSuscripcion = async (empresaId: number, valorMensual: number): Promise<SuscripcionEmpresa> =>
  (await apiClient.post<SuscripcionEmpresa>(`/plataforma/suscripciones/${empresaId}/activar`, { valorMensual })).data;
...
export const marcarPagoManual = async (empresaId: number): Promise<SuscripcionEmpresa> =>
  (await apiClient.post<SuscripcionEmpresa>(`/plataforma/suscripciones/${empresaId}/marcar-pago-manual`)).data;
